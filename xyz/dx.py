...
def source_df(spark_session):
    ...
    data = [
        (1234567, 1000.00, 25, 10, 2.50),
        (87654321, 500.50, 35, 5, 10.00)
    ]
    # Define schema
...
def test_account_number_padding(source_df):
    ...
    assert result_df.select("ACCOUNT_NIUMBER").collect()[0][0] == "00000001234567"
...
def test_total_price_calculation(source_df):
    ...
    assert result_df.select("TOTAL_PRICE").collect()[0][0] == 25.00
```
